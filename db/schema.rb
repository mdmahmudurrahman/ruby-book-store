...
ActiveRecord::Schema.define(version: 20161001192147) do
  ...
  create_table "authorisations", force: :cascade do |t|
    ...
    t.index ["author_id", "book_id"], name: "index_authorisations_on_author_id_and_book_id", unique: true, using: :btree
    t.index ["author_id"], name: "index_authorisations_on_author_id", using: :btree
    t.index ["book_id", "author_id"], name: "index_authorisations_on_book_id_and_author_id", unique: true, using: :btree
  ...
  create_table "categorisations", force: :cascade do |t|
    ...
    t.index ["book_id", "category_id"], name: "index_categorisations_on_book_id_and_category_id", unique: true, using: :btree
    t.index ["book_id"], name: "index_categorisations_on_book_id", using: :btree
    t.index ["category_id", "book_id"], name: "index_categorisations_on_category_id_and_book_id", unique: true, using: :btree
